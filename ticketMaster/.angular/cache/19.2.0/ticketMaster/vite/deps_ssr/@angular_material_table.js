...
import {
  MatCommonModule
} from "./chunk-QN32YQUT.js";
import {
  BidiModule,
  Directionality
} from "./chunk-TBXJFJNW.js";
import {
  Platform,
  RtlScrollAxisType,
  _isNumberValue,
...
} from "./chunk-OM2EZPE6.js";
import {
  DOCUMENT
} from "./chunk-SSNMLJY4.js";
import {
...
var CdkTable = class _CdkTable {
  ...
  _onDestroy = new import_rxjs3.Subject();
   ...
   * @docs-private
   */
  viewChange = new import_rxjs3.BehaviorSubject({
    start: 0,
  ...
  _observeRenderChanges() {
    ...
    } else if ((0, import_rxjs3.isObservable)(this.dataSource)) {
      dataStream = this.dataSource;
    } else if (Array.isArray(this.dataSource)) {
      dataStream = (0, import_rxjs3.of)(this.dataSource);
    }
  ...
  _setupStickyStyler() {
    ...
    (this._dir ? this._dir.change : (0, import_rxjs3.of)()).pipe((0, import_operators2.takeUntil)(this._onDestroy)).subscribe((value) => {
...
var MatTableDataSource = class extends DataSource {
  ...
  _updateChangeSubscription() {
    ...
    const filteredData = (0, import_rxjs4.combineLatest)([dataStream, this._filter]).pipe((0, import_operators3.map)(([data]) => this._filterData(data)));
    const orderedData = (0, import_rxjs4.combineLatest)([filteredData, sortChange]).pipe((0, import_operators3.map)(([data]) => this._orderData(data)));
    const paginatedData = (0, import_rxjs4.combineLatest)([orderedData, pageChange]).pipe((0, import_operators3.map)(([data]) => this._pageData(data)));
